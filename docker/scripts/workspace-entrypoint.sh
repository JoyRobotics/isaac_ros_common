...
# tmux send-keys -t dia_log:0.0 'tail -f /var/log/joy_robot/1_diablo_ctrl_node.log' C-m
# tmux send-keys -t dia_log:0.1 'tail -f /var/log/joy_robot/2_navigation.log' C-m
# tmux send-keys -t dia_log:0.2 'tail -f /var/log/joy_robot/3_perceptor.log' C-m
# tmux send-keys -t dia_log:0.3 'tail -f /var/log/joy_robot/4_lidar_mapping.log' C-m
# tmux send-keys -t dia_log:0.4 'tail -f /var/log/joy_robot/5_teleop.log' C-m
